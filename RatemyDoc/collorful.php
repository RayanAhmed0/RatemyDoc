...
<body>
  ...
  <form class="search-container" method="post" action="resultpage.php">
    <div class="search-container">

      <input type="text" name="search" placeholder="ابحث..." class="search-input">
  </form>
  <input type="submit" name="input" value="Search" class="search-btn" />
  ...
  <style>
    ...
    .fas fa-search {
      background-image: url("https://use.fontawesome.com/releases/v5.6.1/css/all.css");
    }
