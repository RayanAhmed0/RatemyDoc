...
$stmt = $pdo->prepare("SELECT * FROM `docs2` WHERE `name_1` like ?");
...
?>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="navbar-collapse collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="active"><a style="font-size:20px"> 5 / التحضير <?php echo $atnd / $numofrate; ?> </a>
                                    </li>
                ...
                <main id="main">
                    ...
                    <div class="container">
                        ...
                        <div class="row section topspace">
                            <div class="col-md-12">
                                <p class="lead text-center text-muted"> متوسط تقييم المحاضر من الطلاب
                                    <a><?php echo $r["total by 5"] ?> / 5<br></a> عدد مرات تقييم المحاضر
                                    <a><?php echo $r["number of rate"] ?> مره/مرات </a>
                                </p>
                            </div>
                        </div> <!-- / section -->
                        ...
                        <div class="row section featured topspace" method='post'>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-3">
                                    ...
                                    <p style="text-align:center;">تقييم التحضير يعتمد على سهولة المحاضر في التحضير وسماحتة في قبول
                                        الاعذار</p>
                                    <bbody>
                                        <divv>
                                            <span id="rangeValue">0</span>
                                            <Input class="range" type="range" id="v1" value="0" min="0" max="5" onChange="rangeSlide(this.value)" onmousemove="rangeSlide(this.value)"></Input>
                                        </divv>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    ...
                                    <p style="text-align:center;">تقييم الدرجات يعتد على سهولة الحصول على الدرجات والتجاوز عن
                                        الاخطاء</p>
                                    <bbody>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    ...
                                    <p style="text-align:center;">سهولة توصيل المعلومة الى الطالب وتوضيح الافكار المتعلقة بالموضوع
                                    </p>
                                    <bbody>
            ...
            <div>
                <form action="" method="POST">
                    <a href="TY.html" onclick="myFunction()" class="myButton" value="search">ارسال</a>
            ...
            <script>
                function myFunction() {
                    // the problem is here in those variables \/\/\/\/\/\/

                    var atnds = 20;
                    //document.getElementById('rangeValue').innerHTML;
                    document.cookie = "atnds=" + atnds;
                    var marks = 21;
                    //document.getElementById('rangeValuee').innerHTML;
                    document.cookie = "marks=" + marks;
                    var tea = 22;
                    //document.getElementById('rangeValueee').innerHTML;
                    document.cookie = "tea=" + tea;
                    var cumm = 23;
                    //document.getElementById('rangeValueeee').innerHTML;
                    document.cookie = "cumm=" + cumm;

                    <?php
                    // to pass cookies from JS to PHP 
                    $atndss_cookie = $_COOKIE['atnds'];
                    $markss_cookie = $_COOKIE['marks'];
                    $teass_cookie = $_COOKIE['tea'];
                    $cummss_cookie = $_COOKIE['cumm'];

                    $atndss =  ' <script> document.writeln($atnds); </script>';
                    $markss = ' <script> document.writeln(marks); </script>';
                    $teass = ' <script> document.writeln(tea); </script>';
                    $cummss = ' <script> document.writeln(cumm); </script>';


                    $numofratex = $numofrate + 1;
                    $atndsx = $atnd +  $atndss;
                    $marksx = $mark +  $markss;
                    $teax = $teach +  $teass;
                    $cummx = $comu + $cummss;
...
*/
                    ...
                    $sql =
                        " UPDATE `docs2` SET `attendance` = $atndsx,`marks` = $marksx,`teaching` = $teax,`communication` = $cummx,`number of rate` = $numofratex WHERE `docs2`.`id` = $urla;'";
