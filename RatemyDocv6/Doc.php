...
<header id="header">
	...
	<nav class="navbar navbar-default navbar-sticky">
		<div class="container-fluid">
          ...
          $cu = substr($cu, 0, 4);
          ?>
					<li class="active"><a style="font-size:20px"> 5 / التحضير <?php echo $at ?> </a> </li>
					<li><a style="font-size:20px"> 5 / الدرجات <?php echo $mr ?> </a> </li>
					<li class="dropdown">
					<a style="font-size:20px"> 5 / الشرح <?php echo $te ?> </a> 
					</li>
					<li><a style="font-size:20px"> 5 / التعامل <?php echo $cu ?> </a> </li>
				</ul>
...
<main id="main">
	...
	<div class="container">
		...
		<div class="row section topspace">
			<div class="col-md-12">
        <?php 
        $tb5 = ($mark/$numofrate)+($atnd/$numofrate)+($teach/$numofrate)+($comu/$numofrate);
        $tb5= $tb5/4;
        $tb5 = substr($tb5, 0, 4);
          ?>
				<p class="lead text-center text-muted"> متوسط تقييم المحاضر من الطلاب <a ><?php echo $tb5;?> / 5<br></a> عدد مرات تقييم المحاضر <a><?php echo $r["number of rate"]?> مره/مرات </a></p>
			</div>
		</div> <!-- / section -->
...
.range::-webkit-slider-thumb {
  ...
  <p  type="submit" class="text-center" name="sendy" id="sendy" onclick="myFunction()" ><a class="btn btn-action">أرسل</a>
 ...
 <script>
   $idd= <?php echo $urla; ?>;
   $numofrate= <?php echo $numofrate; ?>;
   $atndbe =<?php echo $atnd; ?>;
   $markbe = <?php echo $mark; ?>;
   $teachbe =<?php echo $teach; ?>;
   $comube = <?php echo $comu; ?>;
function myFunction() {
 ...
 window.location.href = "\TY.php?rate="+$idd+$atnds+$marks+$tea+$cumm+$numofrate+$atndbe+$markbe+$teachbe+$comube;
