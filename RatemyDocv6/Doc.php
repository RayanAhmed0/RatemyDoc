...
<divv>
        ...
        <Input class="range" type="range" name "" value="0" min="0" max="5" onChange="rangeSlide(this.value)" onmousemove="rangeSlide(this.value)"></Input>
    </divv>
...
<divv>
        ...
        <Input class="range" type="range" name "" value="0" min="0" max="5" onChange="rangeSlidee(this.value)" onmousemove="rangeSlidee(this.value)"></Input>
    </divv>
    <script type="text/javascript">
...
<bbody>
<divv>
        <span id="rangeValueee">0</span>
        <Input class="range" type="range" name "" value="0" min="0" max="5" onChange="rangeSlideee(this.value)" onmousemove="rangeSlideee(this.value)"></Input>
    </divv>
    <script type="text/javascript">
...
<divv>
        ...
        <Input method='POST' class="range" type="range" name "aassdd" value="0" min="0" max="5" onChange="rangeSlideeee(this.value)" onmousemove="rangeSlideeee(this.value)"></Input>
    </divv>
    <script type="text/javascript">
...
.range::-webkit-slider-thumb {
 ...
 <p class="text-center" ><a href="" class="btn btn-action">أرسل</a></p>

	</style>
  <?php
   $value_4 = $_POST['aassdd'];
   echo $value_4;
