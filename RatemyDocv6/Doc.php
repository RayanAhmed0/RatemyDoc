...
<divv>
        ...
        <Input class="range" type="range" name "" value="0" min="0" max="5" onChange="rangeSlideeee(this.value)" onmousemove="rangeSlideeee(this.value)"></Input>
    </divv>
    <script type="text/javascript">
